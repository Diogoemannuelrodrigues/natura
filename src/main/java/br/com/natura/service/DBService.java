...
public class DBService {
    ...
    public void instantiateTestDatabase() throws java.text.ParseException {
        ...
        Produto p1 = new Produto(null, "Perfume 212", 123546, "Perfume 212", 229.90, TipoProduto.PERFUMARIA);
        Produto p2 = new Produto(null, "Perfume Natura", 894842, "Perfume NAtura", 29.90, TipoProduto.PERFUMARIA);
